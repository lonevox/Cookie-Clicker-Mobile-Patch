		...
		{name:'misc',nameD:'Misc',icon:4,build:function(el){
			...
			str+=G.button({text:`${G.iconSmall(16,5)}Settings`,classes:'bumpButton halfButton',onclick:function(){
				G.popup({text:`
					...
					`+(DEV?G.stateButton({text:'Auto Golden Cookie Click',comment:'Automatically clicks golden cookies<br>and cookie storm cookies.',tieToSetting:'autogoldencookieclick'}):'')+`
					`+(DEV?G.stateButton({text:'Auto Wrath Cookie Click',comment:'Automatically clicks wrath cookies<br>and cookie storm cookies.',tieToSetting:'autowrathcookieclick'}):'')+`
